...
while True:
    ...
    screen = cv2.circle(screen, circle_center, circle_radius, (255, 255, 255), 2)
    ...
    if results.pose_landmarks:
        ...
        screen = cv2.line(screen, left_shoulder_point, right_shoulder_point, (0, 0, 255), 2)
        screen = cv2.line(screen, mid_shoulder_point, left_ankle_point, (0, 0, 255), 2)
        screen = cv2.line(screen, mid_shoulder_point, right_ankle_point, (0, 0, 255), 2)
        screen = cv2.line(screen, neck_point, mid_shoulder_point, (0, 0, 255), 2)
        screen = cv2.line(screen, left_shoulder_point, left_wrist_point, (0, 0, 255), 2)
        screen = cv2.line(screen, right_shoulder_point, right_wrist_point, (0, 0, 255), 2)

        if x_min < x_max and y_min < y_max:
            screen = cv2.rectangle(screen, (x_min, y_min), (x_max, y_max), (255, 0, 0), 2)
    ...
    cv2.imshow("IA ESP CREATED BY KAYY", screen)
